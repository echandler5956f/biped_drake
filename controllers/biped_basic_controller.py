...
class BipedBasicController(LeafSystem):
    """
    A simple PD controller for a biped robot. 
    ...
    def __init__(self, plant, dt, use_lcm=False):
        ...
        self.body_frame = self.plant.GetFrameByName("body")   # "body" for huron

        self.l_foot_frame = self.plant.GetFrameByName("L_FOOT")  # left
        self.r_foot_frame = self.plant.GetFrameByName("R_FOOT")  # right
        ...
        self.l_foot_frame_autodiff = self.plant_autodiff.GetFrameByName("L_FOOT")
        self.r_foot_frame_autodiff = self.plant_autodiff.GetFrameByName("R_FOOT")
    ...
    def ControlLaw(self, context, q, v):
        ...
        # Tuning parameters
        Kp = 30.0*np.eye(self.plant.num_velocities())/3.0
