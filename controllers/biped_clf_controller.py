from controllers.biped_inverse_dynamics_controller import *

class BipedCLFController(BipedIDController):
    """
    ...
    def __init__(self, plant, dt, use_lcm=False):
        BipedIDController.__init__(self, plant, dt, use_lcm=use_lcm)
