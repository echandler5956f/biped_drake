from controllers.biped_mptc_controller import *

class BipedPCController(BipedMPTCController):
    """
    ...
    def __init__(self, plant, dt, use_lcm=False):
        BipedMPTCController.__init__(self, plant, dt, use_lcm=use_lcm)
    ...
    def ControlLaw(self, context, q, v):
        ...
        if swing_feet[0]:
            Jd_s.append(self.CalcFrameJacobianDot(self.l_foot_frame_autodiff))
        if swing_feet[1]:
            Jd_s.append(self.CalcFrameJacobianDot(self.r_foot_frame_autodiff))
